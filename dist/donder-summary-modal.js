...
console.warn("The main 'lit-element' module entrypoint is deprecated. Please update your imports to use the 'lit' package: 'lit' and 'lit/decorators.ts' or import from 'lit-element/lit-element.ts'. See https://lit.dev/msg/deprecated-import-path for more information.");class bt extends X{static get properties(){return{disabled:{reflect:!0,type:Boolean},min:{type:Number},max:{type:Number},step:{type:Number},value:{type:Number}}}constructor(){super(),this.disabled=!1,this.min=0,this.max=100,this.value=0,this._actualMin=this.min,this._actualMax=this.max,this._input={},this._slider={},this._thumb={}}async firstUpdated(){if(this._input=this.shadowRoot.querySelector("input"),this._slider=this.shadowRoot.querySelector(".range-slider"),this._thumb=this.shadowRoot.querySelector(".range-thumb"),this._actualMin=this.min,this._actualMax=this.max,this.step){const t=this.min%this.step,e=this.max%this.step;0!==t&&(this.min=this.min-t),0!==e&&(this.max=this.max+this.step-e)}}updated(t){t.has("value")&&this._updateSlider()}static styles=n`
  ...
  `;render(){return O`
    ...
    `}throttleUpdate(t,e){if(!this._initiated)return void(this._initiated=!0);const[i]=t.composedPath(),s=parseInt(i.value);clearTimeout(this._throttle),this._throttle=setTimeout((()=>{this.hass.callService("cover","set_cover_position",{entity_id:e.entity,position:s})}),2e3)}renderShutters(t){var e;const i=null===(e=this.hass.states[t.entity||""].attributes)||void 0===e?void 0:e.current_position;return O`
      <range-slider
        .min=${0}
        .max=${100}
        .step=${20}
